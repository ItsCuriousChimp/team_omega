...
class SeatService:
    ...
    def get_all_seats(self, showtime_pk: str) -> list[dict]:
        all_seats_of_showtime = self.seat_repository.get_all_seats(showtime_pk)
        return all_seats_of_showtime

    def get_unavailable_seats(self, showtime_pk: str) -> list[dict]:
        unavailable_seat_of_showtime = self.seat_repository.get_unavailable_seats(
            showtime_pk
        )
    ...
    def get_seat_available(self, showtime_pk: str) -> list[dict]:
        available_seat_of_showtime = self.seat_repository.get_available_seats(
            showtime_pk
        )
